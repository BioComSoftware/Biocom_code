...
if __name__ == '__main__':
    """
    Possible metrics (based on whats available from /proc/meminfo)
    
    'WritebackTmp', 'SwapTotal', 'Active(anon)', 'SwapFree', 'DirectMap4k',
    'KernelStack', 'MemFree', 'HugePages_Rsvd', 'Committed_AS', 'Active(file)',
    'NFS_Unstable', 'VmallocChunk', 'Writeback', 'Inactive(file)', 'MemTotal',
    'VmallocUsed', 'HugePages_Free', 'AnonHugePages', 'AnonPages', 'Active', 
    'Inactive(anon)', 'CommitLimit', 'Hugepagesize', 'Cached', 'SwapCached', 
    'VmallocTotal', 'Shmem', 'Mapped', 'SUnreclaim', 'Unevictable',
    'SReclaimable', 'Mlocked', 'DirectMap2M', 'HugePages_Surp', 'Bounce',
    'Inactive', 'PageTables', 'HugePages_Total', 'Slab', 'Buffers', 'Dirty'
