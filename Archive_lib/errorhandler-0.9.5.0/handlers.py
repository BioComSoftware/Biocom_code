...
from twisted.trial.test import novars
...
from common.errorhandler.formatters import _format_original_error,_log_error
from common import move_file
from common.errorhandler.customexceptions import CustomError,FatalException
...
#         return args, kwargs, True
    ...
    def DBHostNotFound(callobj, args, kwargs, e):
        """
        """
        
        # Create custom message to BE SENT TO THE LOGGER
        default_host = '10.208.183.196'
        message = (''.join(["'db_host' not known. Using default of ", 
                            "'", str(default_host), "'."]))    
        ...
        # This sets the variable directly in the calling object. 
        # It does not pass back through return 
        callobj.config.db_host = default_host
        return args, kwargs, str(sys._getframe().f_code.co_name)
