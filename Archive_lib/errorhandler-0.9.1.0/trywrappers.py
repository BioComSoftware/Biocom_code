...
def handlertry(msg, tries = 1):
    ...
    :DESCRIPTION:
        ...
        paradigm in Python. The "msg" parameter must contains a "human readable 
        signal phrase" which is passed to the ErrorHandler.customErr method 
        which, in turn, uses the phrase to send control to the appropriate 
        ErrorHandler.<handler_method>.  
